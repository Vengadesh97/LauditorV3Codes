...
public class CreateMatterTest extends BaseClass {
	...
	public void clientsIndividuals(HashMap<String, String> input) throws InterruptedException {
		...
		Thread.sleep(3000);
		createMatter.tempClientIndividuals(input.get("searchTextIndividuals"), input.get("firstName"), input.get("lastName"), input.get("email"), input.get("confirmEmail"), input.get("country"), input.get("phoneNumber"));
		Thread.sleep(3000);
		createMatter.tempClientEntity(input.get("searchTextEntity"), input.get("firmName"), input.get("contactPerson"), input.get("emailId"), input.get("confirmEmailId"), input.get("countryEntity"), input.get("mobileNumber"));
...
/*	
	...
	public void clientsIndividualsandEntityWithTMandDocuments(HashMap<String, String> input) throws InterruptedException {
	...
	*/
	...
	// Mandatory Fields with Groups and Clients [Individuals and Entity] with Team Members
	@DataProvider
	...
	// Mandatory Fields with Groups and Clients [Individuals and Entity] with Documents
	@DataProvider
	...
	// Mandatory Fields with Groups and Clients [Individuals and Entity] and TM with Documents
	@DataProvider
