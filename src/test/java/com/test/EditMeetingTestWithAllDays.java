...
public class EditMeetingTestWithAllDays extends BaseClass {

	@Test(dataProvider = "getData0", priority = 0)
	public void editMeetingWithReptitionWithAllDays(HashMap<String, String> input) throws InterruptedException {
	...
	public void editMeetingWithAllDays(HashMap<String, String> input) throws InterruptedException {
		...
		try {
			...
			Thread.sleep(1000);
			viewMeeting.assertMeetingName(input.get("meetingnameAssert"));
			viewMeeting.assertMonthandTime1(input.get("date"), input.get("month"), input.get("year"),
					input.get("monthAndTime"));
	...
	public Object[][] getData0() throws IOException {
		...
		List<HashMap<String, String>> data = getJsonDataToMap(
				"C:\\Users\\Vengadesh\\git\\LauditorV3Codes\\Lauditor\\src\\test\\java\\file\\data\\meeting\\editMeetingWithAllDays.json");
	...
	public Object[][] getData1() throws IOException {
		...
		return new Object[][] { { data.get(55) }, { data.get(56) }, { data.get(57) }, { data.get(58) },
				{ data.get(59) }, { data.get(60) }, { data.get(61) }, { data.get(62) }, { data.get(63) },
				{ data.get(64) }, { data.get(65) } };
	}
